    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mname = Objects.requireNonNull(mDisplayName.getEditText()).getText().toString();
                memail = Objects.requireNonNull(mEmail.getEditText()).getText().toString();
                mpassword = Objects.requireNonNull(mPassword.getEditText()).getText().toString();
